...
const Tech = () => {
  return (
    ...
    <motion.div variants={textVariant2()}>
      ...
      <p className = {`${styles.sectionSubText} text-center`}>Main Programming Languages: Python, C++, Java</p>
      <p className = {`${styles.sectionSubText} text-center`}>Main Software: Visual Studio, Google Colab, Git, Jupyter, LaTeX, RStudio</p>
      <p className = {`${styles.sectionSubText} text-center`}>Main Technical Skills: Software Development, Machine Learning, Computer Vision, AI, Neural Nets, Decision Trees, Algorithms, Image Processing, OOP</p>
    </motion.div>
